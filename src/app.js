...
const PT={
  ...
  bakke:[55.4116,12.2458], school:[55.4011,12.2636], hal:[55.4032,12.2640], elle:[55.4110,12.2543], ege:[55.4154,12.2560], center:[55.4164,12.2424], egehaven:[55.4065,12.2547],
...
const loop=[PT.center,PT.j1,[55.4166,12.2450],[55.4160,12.2500],[55.4150,12.2545],PT.ege,[55.4140,12.2600],[55.4120,12.2660],PT.lendrumN,[55.4069,12.2706],PT.lendrumMid,PT.hal,PT.school,PT.j4,[55.4025,12.2600],PT.nicol,PT.egehaven,PT.j3,[55.4080,12.2510],PT.elle,[55.4105,12.2500],PT.j2,PT.bakke,[55.4140,12.2440],PT.center];
...
const MEAS=[
 ...
 {id:'hal',s:['k75','k10'],w:'upg',sym:'hall',t:'Medborgerhus i Ellehallen + udbygget Strøbyhallen',e:'Aftenspids 17-21: 200-300 bilankomster pr. aften, P deles med skolen. Kræver at Lendrumvej-knuden virker om aftenen og at sløjfen giver cykel-/gangadgang.',at:PT.hal},
 ...
 {id:'loop',s:['k75','k10'],w:'cycle',sym:'loop',t:'Sammenbindingssløjfen (5 km cykel- og gangring)',e:'Centret - marina - kysten - Lendrumvej - idrætscenter/Ellehallen - Strøbyskolen - Nicolinelund - Egehaven - Centret. Binder byens nye mødesteder sammen uden bil.',geo:{line:loop,cls:'loop'},at:[55.4120,12.2660],
 ...
 {id:'areas75',s:['k75'],w:'area',sym:'area',t:'Boligetaper E0-E2: Stolpegården, Lendrumvej-kilen og Idrætstorvets bydel (ca. 58 ha, ca. 735 boliger)',e:'Først hullet ved Stolpegården (Nicolinelund 3.3-3.4), så Lendrumvej-kilen og bydelen syd for skolen. Sammen med de 11 ha restrummelighed giver det ca. 7.650 indbyggere. Se afsnittet "Boliger og erhverv".',geo:{etaper:['E0','E1','E2']},at:[55.4060,12.2680]},
 ...
 {id:'kultur',s:['k75','k10'],w:'upg',sym:'kultur',t:'Kulturhuset i Ellehallen (Ellevej): sal, café, bibliotek og tankesport',e:'Ellehallen = kulturhus og medborgerhus med sal til 200 (teater, biograf, koncert), café og tankesport; biblioteket (Kystvejen 7A i dag) kan flytte med. Ligger midt i boligkvartererne mellem Centret og skolen - 700 m fra Stolpegården, 900 m fra Centret. Strøbyhallen ved skolen udbygges med café (Idrætstorvet).',at:PT.elle,
...
const STORY={
 ...
 <p id="story-model"></p>
 <h3>Det afgørende: omfartsvej og statsvej skal åbne sammen</h3>
 <p>En kommunal omfartsvej alene flytter køen fra Stevnsvej til Køgevej og Prambroen - alle skal stadig over den samme bro og gennem Køge. Først når statsvejen (Alternativ N) fører trafikken vest om til E47 ved Herfølge, aflastes Prambroen og Strandvejen. Vejdirektoratets tidsplan er miljøvurdering 2027-29 og anlæg fra 2030; kommunen har bedt om at fremrykke den (KB 25-06-2024).</p>
 <h3>Hvad der skifter i byen</h3>
 <p>Stevnsvej nedklassificeres til bygade med byporte og 40 km/t. Lendrumvej-krydset bliver byens hovedindgang med skole, Strøbyhallen og omfartsvej i samme punkt; kulturhuset i Ellehallen ligger 900 m mod nord midt i boligkvartererne. Marinaen (600 både) og kystprojektet lægger ny fritidstrafik på kysten - den må ikke gå gennem Kystvejen. Sammenbindingssløjfen binder de nye mødesteder sammen for cykel og gang.</p>
...
const ATTN=[
 ...
 ['Lendrumvej-knuden designes før medborgerhuset åbner','Skole, idrætscenter, Ellehallen og omfartsvej i samme kryds: rundkørsel, sikret stikrydsning og kiss & ride.'],
...
function renderStructure(){
  ...
  <div class="stack">
   ${it('byport','1 · Bygaden: Stevnsvej fra Prambroen til Idrætstorvet','Når omfartsvejen åbner, bliver Stevnsvej byens hovedgade (40 km/t, 30 i hjertezonen): butikker, kulturhuset i Ellehallen 300 m fra gaden, busstop og sikre krydsninger. Biler er gæster, ikke gennemkørende.')}
  ...
  <div class="stack">
   ...
   ${it('kultur','Kultur i midten: Kulturhuset i Ellehallen','Ellehallen ved Ellevej som kulturhus med sal til 200 (teater, biograf, koncert), café, bibliotek og tankesport - midt i boligkvartererne mellem Centret og skolen, med Stolpegården (E0) og Lendrumvej-kilen (E1) inden for 10 minutters gang. Idrætstorvet ved skolen: Strøbyhallen udbygget med café, kontorfællesskab og daginstitution.')}
...
function drawBuilt(){
  ...
  if(S.bypass){L.marker(PT.elle,{pane:'sym',icon:L.divIcon({className:'sym',html:SYM.kultur(),iconSize:[30,30],iconAnchor:[15,15]})}).bindPopup('<h4>Kulturhuset i Ellehallen</h4><p style="margin:4px 0 0">Ellehallen ved Ellevej som kulturhus og medborgerhus: sal til 200 (teater, biograf, koncert), café, bibliotek, tankesport og foreningsliv - midt i boligkvartererne, 900 m fra Centret, 700 m fra Stolpegården, 900 m fra skolen. Placering omtrentlig.</p>',{maxWidth:340}).addTo(builtLayer);
    lblAt([55.4122,12.2543],'Kulturhuset i Ellehallen','node kultur').addTo(builtLayer);
